...
**Navigation:** [← Back to Manifesto](Manifesto.md) | [Steering Moves Reference](move_types_reference.md)
...
2.  **Expand Your Toolkit**: Study the [Pattern Templates](pattern_templates_v1.md).
    *   *Decision Paralysis?* Use **[Meta → ScopeTighten → Compare](pattern_templates_v1.md#meta--scopetighten--compare)**.
    *   *Blind Spots?* Use **[Seed → Probe → RoleShift](pattern_templates_v1.md#seed--probe--roleshift)**.
...
**Next Step**: Go to [Steering Moves Reference](move_types_reference.md) to see the atoms of the system.
